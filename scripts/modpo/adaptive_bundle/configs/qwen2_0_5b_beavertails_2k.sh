...
export ADAPTIVE_UPDATE_RULE="adamw"
export ADAPTIVE_PER_OBJECTIVE_BATCH_SIZE=2
export ADAPTIVE_GRADIENT_ACCUMULATION_STEPS=1
export ADAPTIVE_WARMUP_RATIO=0.03
export ADAPTIVE_LR_SCHEDULER_TYPE="cosine"
export ADAPTIVE_WEIGHT_DECAY=0.0
export ADAPTIVE_MAX_GRAD_NORM=1.0
export ADAPTIVE_PRUNE_INNER=False
