...
Parameter dimension d = 642; data seed = 7, init seed = 8.
...
|---|---|---|
| final best-so-far GN* | 1.140e-02 | 1.773e-04 |
| plateau found | True | False |
| plateau level | 1.140e-02 | n/a |
| plateau onset (grad evals) | 770 | None |
| CPU time to common target 1.140e-02 | 5.55 s | 14.51 s |
| grad evals to common target | 770 | 160 |

Plateau ratio (baseline / adaptive): **n/a**  
CPU-time ratio to common target (baseline / adaptive): **0.38**  
Gradient ratio to common target (baseline / adaptive): **4.81**  
