# d1794_h32x32_tanh_n50000_B2000
...
Parameter dimension d = 1794; data seed = 7, init seed = 8.
...
|---|---|---|
| final best-so-far GN* | 8.977e-03 | 1.479e-04 |
| plateau found | True | False |
| plateau level | 8.977e-03 | n/a |
| plateau onset (grad evals) | 308 | None |
| CPU time to common target 8.977e-03 | 7.57 s | 16.81 s |
| grad evals to common target | 308 | 160 |

Plateau ratio (baseline / adaptive): **n/a**  
CPU-time ratio to common target (baseline / adaptive): **0.45**  
