# d19458_h128x128_tanh_n50000_B2000
...
Parameter dimension d = 19458; data seed = 7, init seed = 8.
...
|---|---|---|
| final best-so-far GN* | 9.274e-01 | 4.778e-04 |
| plateau found | True | False |
| plateau level | 9.274e-01 | n/a |
| plateau onset (grad evals) | 308 | None |
| CPU time to common target 9.274e-01 | 14.76 s | 68.81 s |
| grad evals to common target | 308 | 160 |

Plateau ratio (baseline / adaptive): **n/a**  
CPU-time ratio to common target (baseline / adaptive): **0.21**  
Gradient ratio to common target (baseline / adaptive): **1.93**  
