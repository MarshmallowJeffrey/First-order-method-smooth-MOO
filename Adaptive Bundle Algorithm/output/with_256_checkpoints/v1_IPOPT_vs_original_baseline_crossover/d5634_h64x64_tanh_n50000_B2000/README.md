# d5634_h64x64_tanh_n50000_B2000
...
Parameter dimension d = 5634; data seed = 7, init seed = 8.
...
|---|---|---|
| final best-so-far GN* | 9.846e-02 | 2.961e-04 |
| plateau found | False | False |
| plateau level | n/a | n/a |
| plateau onset (grad evals) | None | None |
| CPU time to common target 9.846e-02 | 57.64 s | 28.60 s |
| grad evals to common target | 2000 | 160 |

Plateau ratio (baseline / adaptive): **n/a**  
CPU-time ratio to common target (baseline / adaptive): **2.02**  
Gradient ratio to common target (baseline / adaptive): **12.50**  
