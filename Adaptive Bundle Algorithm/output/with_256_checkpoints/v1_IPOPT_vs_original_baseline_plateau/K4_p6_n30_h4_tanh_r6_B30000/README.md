...
Parameter dimension d = 48; data seed = 7, init seed = 8.
...
|---|---|---|
| final best-so-far GN* | 3.560e-02 | 2.836e-03 |
| plateau found | False | True |
| plateau level | n/a | 2.836e-03 |
| plateau onset (grad evals) | None | 13200 |
| CPU time to common target 3.560e-02 | 6.49 s | 49.38 s |
| grad evals to common target | 25200 | 3600 |

Plateau ratio (baseline / adaptive): **n/a**  
CPU-time ratio to common target (baseline / adaptive): **0.13**  
Gradient ratio to common target (baseline / adaptive): **7.00**  
