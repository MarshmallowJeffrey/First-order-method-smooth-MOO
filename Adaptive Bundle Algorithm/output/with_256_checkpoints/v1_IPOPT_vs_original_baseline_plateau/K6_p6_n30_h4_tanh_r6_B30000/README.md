...
|---|---|---|
| final best-so-far GN* | 4.773e-03 | 1.924e-02 |
| plateau found | False | False |
| plateau level | n/a | n/a |
| plateau onset (grad evals) | None | None |
| CPU time to common target 1.924e-02 | 2.78 s | 613.21 s |
| grad evals to common target | 12000 | 28800 |

Plateau ratio (baseline / adaptive): **n/a**  
CPU-time ratio to common target (baseline / adaptive): **0.00**  
Gradient ratio to common target (baseline / adaptive): **0.42**  
