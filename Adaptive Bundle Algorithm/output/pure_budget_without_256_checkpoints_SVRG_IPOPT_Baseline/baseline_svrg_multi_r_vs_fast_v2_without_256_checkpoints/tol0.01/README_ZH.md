...
0.01（精确、full-gradient Gram——随机性无法伪造证书）。被
求解的节点推进到 solve_target = 0.0025
...
Fast adaptive 曲线原样复用自 `/Users/shirch/vscode101/.venv/First-order-method-smooth-MOO/Adaptive Bundle Algorithm/output/fast_method_trials/trial_K6_d11910_h96x96_tanh_n50000_eps0.001_fast_msvrg_without_256_checkpoints_v4_strict_rel0.1`（已披露；其画的是粗档
