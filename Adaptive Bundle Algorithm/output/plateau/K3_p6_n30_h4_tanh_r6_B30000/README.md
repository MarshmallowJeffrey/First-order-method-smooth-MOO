...
Parameter dimension d = 43; data seed = 7, init seed = 8.
...
|---|---|---|
| final best-so-far GN* | 8.969e-03 | 1.722e-04 |
| plateau found | False | False |
| plateau level | n/a | n/a |
| plateau onset (grad evals) | None | None |
| CPU time to common target 8.969e-03 | 7.63 s | 48.20 s |
| grad evals to common target | 30000 | 3600 |

Plateau ratio (baseline / adaptive): **n/a**  
CPU-time ratio to common target (baseline / adaptive): **0.16**  
Gradient ratio to common target (baseline / adaptive): **8.33**  
(ratios > 1 mean the adaptive method is better)

## Health checks

- `L_scale_final` = 2.0 (>1 means the probe-estimated smoothness constants were raised at runtime by the descent safeguard; expected on ReLU MLPs)
